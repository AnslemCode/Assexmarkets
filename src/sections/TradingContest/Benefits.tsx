  ...
  return (
    <section className="py-20">
      <div className="max-w-7xl mx-auto flex flex-col items-center px-4 sm:px-6">
        ...
        <motion.h1
          className="font-secondary font-bold text-3xl sm:text-4xl lg:text-[40px] text-[#191A15] mt-6 text-center"
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true }}
          variants={fadeInUp}
        ...
        <motion.p
          className="text-base sm:text-lg lg:text-xl text-center mt-6 max-w-3xl mx-auto text-[#3F4550]"
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true }}
          variants={fadeInUp}
