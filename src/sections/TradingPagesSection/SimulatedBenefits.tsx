...
type ReusableBenefitsProps = {
  ...
  rightContent?: React.ReactNode; // ← flexible right-hand content
};
...
const ReusableBenefitsSection = ({
  ...
  return (
    <section className="mt-30">
      <div className="max-w-6xl mx-auto bg-[#1DA1F2]/2 rounded-[60px] px-[50px] pt-[55px] pb-[26px]">
        <h1 className="text-[#1F0d3F] text-center font-bold text-4xl max-w-3xl mx-auto leading-[65px]">
          {title}
        </h1>
        <div className="mt-[50px] pt-8 pb-[42px] flex gap-[100px] items-center flex-wrap">
          {/* Left - Benefits */}
          ...
          <div className="flex-1 w-full md:w-auto">{rightContent}</div>
        </div>
      </div>
    </section>
  );
